          ...
          {projects.map((project, i) => {
            ...
            return (
              <RevealOnScroll key={project.id} delay={i * 0.08}>
                <article className="group relative bg-background p-8 flex flex-col gap-5 h-full">
                  {project.imageUrl && (
                      ...
                      <div className="flex items-center gap-2 shrink-0 relative z-10">
                        {project.liveUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            aria-label={locale === "fr" ? "Voir le site" : "Visit site"}
                        ...
                        {project.repoUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            aria-label={locale === "fr" ? "Voir le code" : "View code"}
                            className="text-muted-foreground hover:text-foreground transition-colors"
                          >
