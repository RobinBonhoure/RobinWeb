...
const GameMount = dynamic(
  () => import("@/components/game/StackSkills/GameMount"),
  {
    ssr: false,
    loading: () => (
...
export function GameSection({ skills, locale }: Props) {
  return (
    <section id="game" className="px-6 md:px-16 lg:px-24 py-24 bg-secondary/20">
      <div className="max-w-5xl mx-auto">
        <RevealOnScroll>
          <div className="mb-10">
            <h2 className="text-label text-muted-foreground mb-4">
              Stack your skills
            </h2>
